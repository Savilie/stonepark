  ...
  return (
      <div id="cont" className="scroll-smooth">
        ...
        <section className="px-[12vw] py-[3vh] relative h-[100vh] bg-[url(src/assets/bg.png)] bg-[100%_auto] bg-no-repeat" >
          ...
          <Link to="anchor" smooth='true'  className=" cursor-pointer absolute top-[95vh] left-[49vw] z-50" >
            <svg xmlns="http://www.w3.org/2000/svg" width="3vw" height="3vh" viewBox="0 0 1024 1024"><path fill="#ffffff" d="M831.872 340.864L512 652.672L192.128 340.864a30.59 30.59 0 0 0-42.752 0a29.12 29.12 0 0 0 0 41.6L489.664 714.24a32 32 0 0 0 44.672 0l340.288-331.712a29.12 29.12 0 0 0 0-41.728a30.59 30.59 0 0 0-42.752 0z"/>
            </svg>
            </Link>
        </section>
        <SectionTransition text="Натуральная красота в каждом камушке!"/>
        <section id="anchor" className=" flex flex-col items-center justify-between py-[8vh] h-[100vh] bg-[#EDE5DB]">
          <h2 className=" text-[4vh] font-bold text-[#EDE5DB] bg-[#7BA35A] px-[9vw] py-[1.2vh] rounded-xl">Каталог камня</h2>
        </section>
      </div>
  );
}
